...
module.exports = {
  ...
  themeConfig: { // 主题配置
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, link: String}
      name: 'madaozyy', // 必需
      link: 'https://github.com/madaozyy' // 可选的
    },
    blogger: { // 博主信息，显示在首页侧边栏
      avatar: 'https://cdn.jsdelivr.net/gh/xugaoyi/image_store/blog/20200103123203.jpg',
      name: '赵丫丫',
      slogan: '我们终其一生，就是要摆脱他人的期待，找到真正的自己。'
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:zhaoyinyue@foxmail.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/madaozyy'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
    ...
    [
      ...
      // },
      {
        ...
        options: {
          ...
          owner: 'madaozyy', // GitHub仓库所有者
          admin: ['madaozyy'], // 对仓库有写权限的人
